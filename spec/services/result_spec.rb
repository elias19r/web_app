...
RSpec.describe Result do
  describe '#initialize' do
    it 'has default values for errors and attrs' do
    ...
    describe 'setting errors' do
      it 'sets errors from Hash with String or Array values, skips blanks' do
        result = described_class.new(
          {
      ...
      it 'sets errors from Array, skips blanks' do
        result = described_class.new(
      ...
      it 'sets errors from String, Symbol, Numeric, skips blanks' do
        [
      ...
      it 'raises an exception when errors class invalid' do
    ...
    describe 'setting attrs' do
      it 'symbolizes attrs string keys' do
        result = described_class.new(
          nil,
          {
  ...
  describe '#add_errors' do
    it 'adds to errors from Hash with String or Array values, skips blanks' do
    ...
    it 'adds to errors from Array, skips blanks' do
      result = described_class.new('some existing error message')
    ...
    it 'adds to errors from String, Symbol, Numeric, skips blanks' do
      [
    ...
    it 'raises an exception when errors class invalid' do
      ...
      end.to raise_exception(/Could not build_active_model_errors for Result: invalid error_values.class/)
    end
  end

  describe '.success' do
    it 'creates an instance with empty errors and empty attrs' do
  ...
  describe '.failure' do
    ...
    it 'accepts errors and attrs' do
  ...
  describe 'dynamic accessors for attrs' do
    it 'dynamically sets accessors for attrs symbol and string keys' do
      result = described_class.new(
        nil,
        {
          some_attr: 'some value',
      ...
      expect(result.some_attr).to eq('some value')
      expect(result.another_attr).to eq('another value')
      expect(result.public_send('an attr')).to eq('a value')
    end
  end
end
